...
// Опаздываем ли мы по фактическому времени прибытия на дедлайн окна задачи
// (с учётом её длительности).
export function isStopConflict(stop: RouteStopTiming | undefined, task: Task): boolean {
...
export function getRouteConflictIds(tasks: Task[], stops: RouteStopTiming[]): Set<string> {
