...
\begin{center}\itshape (справочное)\end{center}

\begin{center}{\fontsize{14pt}{21pt}\selectfont\bfseries Листинги ключевых фрагментов кода}\end{center}
...
func (a *NearestNeighborTW) Optimize(
    ...
    for len(order) < n {
        // Закрепленный конечный узел — ставим последним.
        ...
        // Проход 2: fallback — без учета окна.
        if next == -1 {
